...
function sol = hat1d_delta3(mu,R,N,L,D1,D11,D2,D22,D3,D33)

% Di = location of delta function, number between 0 and 2N+1
% Dii = amplitude of delta function
...
% Potential
function V = pot(N,D1,D11,D2,D22,D3,D33)
